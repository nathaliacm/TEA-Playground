...
public class Page2Scene: SKScene {
    ...
    public func checkIfIsFinished() {
        if (puzzle1Status && puzzle2Status && puzzle3Status && puzzle4Status && puzzle5Status && puzzle6Status && puzzle7Status) {
            let backPopup = SKSpriteNode(imageNamed: "congratsPopup")
            ...
            PlaygroundPage.current.assessmentStatus = .pass(message: "Congratulations! [Go to next page](@next)")
        }
    }
}
